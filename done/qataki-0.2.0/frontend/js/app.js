// pw__<funktion|keyword> -> unser Keyword. Gespiegelt aus agent-core
// registry.py _KEYWORDS (+ Sonderfaelle). Bei Aenderung dort neu erzeugen.
const PW_KW = {
  "abort": "abort",
  "abort_route": "abort",
  ...
  "current_url": "url",
  "describe": "describe",
  "describe_element": "describe",
  "dismiss_dialog": "dismiss_dialog",
  "double_click": "double_click",
  "drag": "drag",
  "drag_and_drop": "drag",
  "execute_script": "js",
  "expect_count": "count_is",
  "expect_hidden": "hidden",
  "expect_text": "has_text",
  "expect_title": "title_is",
  "expect_url": "url_is",
  "expect_value": "has_value",
  "expect_visible": "visible",
  "fill": "fill",
  "fill_by_label": "fill_label",
  "fill_label": "fill_label",
  "find_by_label": "find_label",
  "find_by_placeholder": "find_placeholder",
  "find_by_role": "find_role",
  "find_by_test_id": "find_testid",
  "find_by_text": "find_text",
  "find_interactive": "find_interactive",
  "find_interactive_elements": "find_interactive",
  "find_label": "find_label",
  "find_placeholder": "find_placeholder",
  "find_role": "find_role",
  "find_testid": "find_testid",
  "find_text": "find_text",
  "focus": "focus",
  "forward": "forward",
  "frame": "frame",
  ...
  "rec_start": "rec_start",
  "rec_stop": "rec_stop",
  "recording_show_actions": "rec_actions",
  "reload": "reload",
  "requests": "requests",
  "right_click": "right_click",
  "screenshot": "shot",
  "screenshot_element": "shot_element",
  "scroll": "scroll",
  "scroll_page": "scroll_page",
  "scroll_to": "scroll",
  "select": "select",
  "select_option": "select",
  "select_option_by_text": "select_text",
  "select_text": "select_text",
  "set_browser": "use_browser",
  "set_cookie": "set_cookie",
  "set_headless": "headless",
  "set_local_storage": "set_storage",
  "set_storage": "set_storage",
  "set_viewport": "viewport",
  "shot": "shot",
  "shot_element": "shot_element",
  "start_recording": "rec_start",
  "stop_recording": "rec_stop",
  "storage": "storage",
  "switch_tab": "tab_switch",
  "switch_to_frame": "frame",
  "switch_to_main": "frame_main",
  "tab_close": "tab_close",
  "tab_list": "tab_list",
  "tab_new": "tab_new",
  ...
  "wait_for": "wait",
  "wait_for_download": "wait_download",
  "wait_for_hidden": "wait_hidden",
...
function app() {
  return {
    ...
    // Playwright-Tools heissen pw__<keyword> -> "pw - <keyword>"
    toolLabel(name) {
      if (!name) return 'Ergebnis'
      if (name.startsWith('pw__')) {
        const kw = PW_KW[name.slice(4)]
        return name + ' - ' + (kw || 'kein keyword bekannt')
      }
      return name
    },
